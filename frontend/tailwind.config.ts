  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "accent-gradient": "linear-gradient(135deg, hsl(var(--accent)), hsl(var(--accent-dim)))",
      },
      keyframes: {
        ...
        "glow-pulse": { "0%, 100%": { boxShadow: "0 0 8px 2px hsl(var(--accent) / 0.3)" }, "50%": { boxShadow: "0 0 24px 6px hsl(var(--accent) / 0.6)" } },
      ...
      boxShadow: {
        ...
        "card-lg": "0 8px 30px rgba(0,0,0,0.5), 0 2px 8px rgba(0,0,0,0.3)",
        "float": "0 4px 20px rgba(0,0,0,0.25), 0 0 0 1px hsl(var(--border) / 0.5)",
      },
    },
  },
  plugins: [
